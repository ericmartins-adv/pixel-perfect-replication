-- ════════════════════════════════════════════════════════════════
-- Manso Villa — Setup completo (cria tabelas + RLS + seed)
-- Execute no Supabase Dashboard → SQL Editor
-- É seguro rodar mesmo se algumas tabelas já existirem
-- ════════════════════════════════════════════════════════════════
...
-- ── Trigger: mapeia e-mail → sócio automaticamente ──────────────
...
-- ── Profiles: mapeia usuários já existentes ──────────────────────
-- Insere automaticamente os profiles de todos os usuários cadastrados
insert into profiles (id, socio_id)
select
  u.id,
  case lower(u.email)
...
where lower(u.email) in (
  'eric@mansovilla.app', 'michael@mansovilla.app', 'heryk@mansovilla.app',
  'ericfsmartins@gmail.com', 'michael.kazuo@gmail.com', 'herykdedeus@outlook.com'
)
on conflict (id) do nothing;

select 'Setup concluído! Tabelas criadas, RLS configurada, dados inseridos.' as resultado;
